# ദശമൂലം ദാമു
Auto Filter bot
##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+ദശമൂലം-ദാമു-AUTO-FILTER-BOT!;created+by+ALINSHAN!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
